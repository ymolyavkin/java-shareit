...
public class ErrorHandler {
    ...
    public Map<String, String> handleJDBCConnectionException(final RuntimeException e) {
        ...
        return Map.of("error", "Нарушение ограничений БД. Статус ошибки 500 INTERNAL_SERVER_ERROR");
    }
    ...
    public Map<String, String> handleEntityNotFound(final RuntimeException e) {
        ...
        return Map.of("error", "Объект не найден в БД. Статус ошибки 404 Not found");
    }
